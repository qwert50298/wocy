package com.usr.usrcloudmqttsdkdemo.view;
...
import com.usr.usrcloudmqttsdkdemo.entity.DataPoints;
import com.usr.usrcloudmqttsdkdemo.entity.OptionResponse;
import com.usr.usrcloudmqttsdkdemo.entity.ReceiveDataPointsMsg;
import com.usr.usrcloudmqttsdkdemo.entity.ReceiveDataPointsResponse;
import com.usr.usrcloudmqttsdkdemo.entity.ReceiveDevAlarm;
import com.usr.usrcloudmqttsdkdemo.entity.ReceiveDevStateMsg;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("onSubscribeAck")) {
                ...
                if (jsondata.contains("devStatus")) {
                    ...
                    ReceiveDataPointsResponse receiveResponse = JSON.parseObject(jsondata, ReceiveDataPointsResponse.class);//new Gson.fromJson(jsondata, ReceiveDataPointsResponse.class);//JSON.parseObject(jsondata, ReceiveDataPointsResponse.class);
                    msg = "接受解析消息回调显示：\n"
                            + "MessageID为：" + messageId
                            + "\nTopic为： " + topic
                            + "\n收到数据点操作应答"
                    ...
                    ReceiveDataPointsMsg receiveDataPointsMsg = JSON.parseObject(jsondata, ReceiveDataPointsMsg.class);//new Gson.fromJson(jsondata, ReceiveDataPointsMsg.class);//JSON.parseObject(jsondata, ReceiveDataPointsMsg.class);
                    msg = "接受解析消息回调显示：\n"
                            + "MessageID为：" + messageId
                            + "\nTopic为： " + topic
                            + "\n收到数据点数据:"
                    ...
                    ReceiveDevAlarm receiveDevAlarm = JSON.parseObject(jsondata, ReceiveDevAlarm.class);//new Gson.fromJson(jsondata, ReceiveDevAlarm.class);;//JSON.parseObject(jsondata, ReceiveDevAlarm.class);
                    msg = "接受解析消息回调显示：\n"
                            + "MessageID为：" + messageId
                            + "\nTopic为： " + topic
                            + "\n收到设备报警推送:"
