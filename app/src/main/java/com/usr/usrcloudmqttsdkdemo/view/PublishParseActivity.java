    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.pub_btn_parse_query_pubdata:
                ...
                if (TextUtils.isEmpty(devid) || TextUtils.isEmpty(slaveIndex) || TextUtils.isEmpty(pointId)) {
                    showToast("请先填写信息");
                } else {
            ...
            case R.id.pub_btn_parse_set_pubdata:
                ...
                if (TextUtils.isEmpty(set_devid) || TextUtils.isEmpty(set_slaveIndex) || TextUtils.isEmpty(set_pointId) || TextUtils.isEmpty(set_pointValue)) {
                    showToast("请先填写信息");
                } else {
                    if (!TextUtils.isEmpty(sts)) {
                        myService.doDisSubscribeParsedforDevId(sts);
