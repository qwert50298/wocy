...
public class NavController extends View {
    ...
    private final static int INNER_COLOR_DEFAULT = Color.parseColor("#33FFFF00");
    private final static int OUTER_COLOR_DEFAULT = Color.parseColor("#33ffffff");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Log.i("TAG","外圆半径："+outRadius+"---内部半径:"+innerRedius);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getAction()==MotionEvent.ACTION_UP){
            ...
            invalidate();
            if(mCallBack!=null){
                Log.i("TAG","********-------------回到原点:X---"+innerCenterX+"----Y:"+innerCenterY+"----Width:"+realWidth+"---Height:"+realWidth);
                mCallBack.onNavAndSpeed(innerCenterX,innerCenterY);
            }
        }
        return true;
    }
    ...
    public float getInnerCenterX(){
        return  this.innerCenterX;
    }

    public float getInnerCenterY(){
        return this.innerCenterY;
    }
    ...
    public float getInnerRedius(){
        return this.innerRedius;
    }
}
