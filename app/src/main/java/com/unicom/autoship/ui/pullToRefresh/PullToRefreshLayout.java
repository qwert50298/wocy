...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			refreshStateImageView
					.setBackgroundResource(R.mipmap.refresh_load_succeed);
			break;
		case FAIL:
		default:
			// 刷新失败
			...
			refreshStateImageView
					.setBackgroundResource(R.mipmap.refresh_load_failed);
			break;
		}
		if (pullDownY > 0)
		{
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			loadStateImageView.setBackgroundResource(R.mipmap.refresh_load_succeed);
			break;
		case FAIL:
		default:
			// 加载失败
			...
			loadStateImageView.setBackgroundResource(R.mipmap.refresh_load_failed);
			break;
		}
		if (pullUpY < 0)
		{
